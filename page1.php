...
if (isset($_GET['nam'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM  meal WHERE meal.name =?");
                ...
                <div>
                    <div class="image_taxt_wrapper" >
                        ...
                        <div class="text">                                
                            ...
                            <h1 itemprop="name" class="name" data-name=" Vegetarian Comfort Food Recipes" ><?php echo $row['titre']; ?></h1>
                            <h3   itemprop="descripton" class="descripton">
                            <?php echo $row['descriptiv']; ?> <a href=""><?php echo $row['name']; ?></a> </h3>
            ...
            <div id="content" class="super_collection super_collection_wrapper2 " >
              ...
              <div class="gid_warap">
                <section id="product1" class="collection_carousel collection_carousel_product section-p1">
                  ...
                  <?php  include('./get_productspe.php')?>
